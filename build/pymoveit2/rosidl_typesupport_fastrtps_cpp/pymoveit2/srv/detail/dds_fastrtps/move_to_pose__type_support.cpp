...
#include "pymoveit2/srv/detail/move_to_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pymoveit2
cdr_serialize(
  const pymoveit2::srv::MoveToPose_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pymoveit2::srv::MoveToPose_Request & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pymoveit2::srv::MoveToPose_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pymoveit2::srv::MoveToPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pymoveit2::srv::MoveToPose_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_pymoveit2
const rosidl_message_type_support_t *
get_message_type_support_handle<pymoveit2::srv::MoveToPose_Request>()
{
  return &pymoveit2::srv::typesupport_fastrtps_cpp::_MoveToPose_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pymoveit2, srv, MoveToPose_Request)() {
  return &pymoveit2::srv::typesupport_fastrtps_cpp::_MoveToPose_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pymoveit2
cdr_serialize(
  const pymoveit2::srv::MoveToPose_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pymoveit2::srv::MoveToPose_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pymoveit2::srv::MoveToPose_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pymoveit2::srv::MoveToPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pymoveit2::srv::MoveToPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pymoveit2::srv::typesupport_fastrtps_cpp::_MoveToPose_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pymoveit2, srv, MoveToPose_Response)() {
  return &pymoveit2::srv::typesupport_fastrtps_cpp::_MoveToPose_Response__handle;
}
...
{
  return &pymoveit2::srv::typesupport_fastrtps_cpp::_MoveToPose__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pymoveit2, srv, MoveToPose)() {
  return &pymoveit2::srv::typesupport_fastrtps_cpp::_MoveToPose__handle;
}
