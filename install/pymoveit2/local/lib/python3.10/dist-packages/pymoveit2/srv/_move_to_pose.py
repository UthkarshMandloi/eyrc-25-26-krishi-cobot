...
class Metaclass_MoveToPose_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('pymoveit2')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_MoveToPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from pymoveit2.srv import _move_to_pose
...
class MoveToPose(metaclass=Metaclass_MoveToPose):
    from pymoveit2.srv._move_to_pose import MoveToPose_Request as Request
    from pymoveit2.srv._move_to_pose import MoveToPose_Response as Response
